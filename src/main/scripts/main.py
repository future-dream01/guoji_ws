...
class MainNode():
    def __init__(self):
        ...
        self.own_position_pub=rospy.Publisher('/mavros/vision_pose/pose',PoseStamped,queue_size=10)  # 当前位置发布到飞控
    ...
    def rplidar_callback(self,msg):     # 激光雷达位姿数据订阅函数
        ...
        self.own_position_pub.publish(msg)
        print("已发布")
        pass

    def send_own_posion(self):
        pass
