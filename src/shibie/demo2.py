...
import torch
import sys
sys.path.append("~/github/guoji_ws/src/shibie")
...
def make_parser():
    ...
    parser.add_argument(
        "--path", default="datasets/2.webm", help="path to images or video"
    )
    ...
    parser.add_argument("-c", "--ckpt", default="/home/jetson/weights/latest_ckpt2.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
