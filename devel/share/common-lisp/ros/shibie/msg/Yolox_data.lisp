...
(cl:defmethod cl:initialize-instance :after ((m <Yolox_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Yolox_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name shibie-msg:<Yolox_data> is deprecated: use shibie-msg:Yolox_data instead.")))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <Yolox_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shibie-msg:target-val is deprecated.  Use shibie-msg:target instead.")
  (target m))

(cl:ensure-generic-function 'x_p-val :lambda-list '(m))
(cl:defmethod x_p-val ((m <Yolox_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shibie-msg:x_p-val is deprecated.  Use shibie-msg:x_p instead.")
  (x_p m))

(cl:ensure-generic-function 'y_p-val :lambda-list '(m))
(cl:defmethod y_p-val ((m <Yolox_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shibie-msg:y_p-val is deprecated.  Use shibie-msg:y_p instead.")
  (y_p m))
