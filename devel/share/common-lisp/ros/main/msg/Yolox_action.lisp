...
(cl:defmethod cl:initialize-instance :after ((m <Yolox_action>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Yolox_action)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main-msg:<Yolox_action> is deprecated: use main-msg:Yolox_action instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <Yolox_action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main-msg:action-val is deprecated.  Use main-msg:action instead.")
  (action m))
